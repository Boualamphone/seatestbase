...
function charitize_setup() {
	 ...
	 * @link https://developer.wordpress.org/reference/functions/add_image_size/
	 */
	add_image_size( 'charitize-main-banner', 1370, 550, true );
...
function charitize_google_fonts() {
	...
	$charitize_font_family_body = $charitize_customizer_all_values['charitize-font-family-Primary'];
	...
	$charitize_fonts[]=$charitize_font_family_body;
...
function charitize_scripts() {
		...
		wp_enqueue_style( 'google-fonts', charitize_google_fonts() );
