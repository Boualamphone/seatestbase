    ...
    function charitize_skip_to_content() {
        ?>
                            <a class="skip-link screen-reader-text" href="#content">
                                <?php esc_html_e( 'Skip to content', 'charitize' ); ?>
                            </a>
                            <?php
    }
endif;
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-8">
                                                    <div class="row">
                                                        <div class="nav-holder">
                                                            <?php
                                    $charitize_enable_donate_button = $charitize_customizer_all_values['charitize-enable-donate-button'];
                                    if ($charitize_enable_donate_button == 1) { ?>
