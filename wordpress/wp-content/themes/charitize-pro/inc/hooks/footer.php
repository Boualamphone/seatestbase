...
if ( ! function_exists( 'charitize_before_footer' ) ) :
    ...
    function charitize_before_footer() {
        ...
        elseif( 4 == $charitize_footer_widgets_number ){
            $col = 'col-md-3';
        }
        else{
            $col = 'col-md-3';
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <?php endif; ?>
                            <?php if( is_active_sidebar( 'footer-col-four' ) && $charitize_footer_widgets_number > 3 ) : ?>
                                <div class="contact-list <?php echo esc_attr( $col );?>">
                ...
                <div class="footer-bottom">
                    ...
                    <?php
                        ...
                        <span class="site-info">
                            ...
                            <span class="sep"> | </span>
                            <?php printf( esc_html__( 'Theme: %1$s by %2$s', 'charitize' ), 'Charitize Pro', '<a href="http://evisionthemes.com/" rel="designer">eVisionThemes</a>' ); ?>
                        </span><!-- .site-info -->
                    <?php
                        }
                    ?>
