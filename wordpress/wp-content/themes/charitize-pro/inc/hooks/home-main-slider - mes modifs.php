...
if ( ! function_exists( 'charitize_featured_slider_array' ) ) :
    ...
    function charitize_featured_slider_array( $from_slider ){
        ...
        $charitize_feature_slider_contents_array[0][''] = '#';
            ...
            >
                ...
                foreach( $charitize_slider_arrays as $charitize_slider_array ){
                    ...
                    if(empty($charitize_slider_array['charitize-feature-slider-image'])){
                        $charitize_feature_slider_image = get_template_directory_uri().'/assets/img/no-image-1260_530.png';
                    }
                    else{
                                        ...
                                        <div class="banner-content-holder">
                                            <div class="banner-content-inner">
                                                <?php if( 1 == $charitize_feature_enable_title) {
                                                    ?>
                                                       <h1 class="slider-title"><a href="<?php echo esc_url( $charitize_slider_array[''] );?>"><?php echo esc_html( $charitize_slider_array['charitize-feature-slider-title'] );?></a></h1> 
                                                    <?php
                                                }
                                                ...
                                                if ( !empty($charitize_feature_enable_button)){ ?>
                                                   <!-- <div class="btn-holder"><a href="<?php echo esc_url( $charitize_slider_array[''] );?>" class="button"><?php echo esc_html( $charitize_customizer_all_values['charitize-fs-enable-button-text'] );?></a></div> -->
                                                <?php } ?>
                                            </div>
                                        </div>
                                    <?php } ?>
