...
if ( ! function_exists( 'charitize_activity_array' ) ) :
    ...
    function charitize_activity_array( $from_activity ){
        ...
        $charitize_activities_contents_array[0]['charitize-activities-title'] = __('PARTICIPATE IN AN EVENT ','charitize');
        $charitize_activities_contents_array[0]['charitize-activities-content'] = __('Unlike other companies, we do not charge hundreds of dollars per theme.','charitize');
        $charitize_activities_contents_array[0]['charitize-activities-link'] = '#';
        $charitize_activities_contents_array[0]['charitize-activities-image'] = get_template_directory_uri()."/assets/img/slider.png";
