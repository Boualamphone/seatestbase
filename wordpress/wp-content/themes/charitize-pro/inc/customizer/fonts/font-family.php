...
/*defaults values*/
$charitize_customizer_defaults['charitize-font-family-Primary'] = 'Ubuntu:400,400italic,500,700';
...
/*setting - controls*/
$charitize_settings_controls['charitize-font-family-Primary'] =
    array(
        'setting' =>     array(
            'default'              => $charitize_customizer_defaults['charitize-font-family-Primary'],
            
        ),
        'control' => array(
            'label'                 => __( 'Body ( paragraph ) Primary', 'charitize' ),
            'description'           => __( 'change primary font family', 'charitize' ),
