...
$charitize_settings_controls['charitize-enable-theme-name'] =
    array(
        'setting' =>     array(
            'default'              => $charitize_customizer_defaults['charitize-enable-theme-name'],
        ),
        'control' => array(
            'label'                 =>  __( 'Enable Theme Name And Powered By Text', 'charitize' ),
            'section'               => 'charitize-footer-options',
            'type'                  => 'checkbox',
            'priority'              => 40,
        )
