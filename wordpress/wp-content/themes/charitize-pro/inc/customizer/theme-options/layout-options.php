...
$charitize_settings_controls['charitize-archive-layout'] =
    array(
        'setting' =>     array(
            'default'              => $charitize_customizer_defaults['charitize-archive-layout'],
        ),
        'control' => array(
            'label'                 =>  __( 'Archive Layout', 'charitize' ),
            'section'               => 'charitize-layout-options',
            'type'                  => 'select',
            'choices'               => array(
                'excerpt-only' => __( 'Excerpt Only', 'charitize' ),
                'thumbnail-and-excerpt' => __( 'Thumbnail and Excerpt', 'charitize' ),
                'full-post' => __( 'Full Post', 'charitize' ),
                'thumbnail-and-full-post' => __( 'Thumbnail and Full Post', 'charitize' ),
            ),
            'priority'              => 30,
        )
    );
...
$charitize_settings_controls['charitize-archive-image-align'] =
    array(
        'setting' =>     array(
            'default'              => $charitize_customizer_defaults['charitize-archive-image-align'],
        ),
        'control' => array(
            'label'                 =>  __( 'Archive Image Alignment', 'charitize' ),
            'section'               => 'charitize-layout-options',
            'type'                  => 'select',
            'choices'               => array(
            ...
            'priority'              => 35,
            'description'              => __('This option only work if you have selected "Thumbnail and Excerpt" or "Thumbnail and Full Post" in Archive Layout options','charitize'),
        )
    );
