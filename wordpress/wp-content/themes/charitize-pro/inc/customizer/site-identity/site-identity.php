...
if (version_compare($wp_version, '4.5', '<')) {
    ...
    $charitize_customizer_defaults['charitize-title-tagline-message'] = sprintf( __( '%s If you do not have a logo %s', 'charitize' ), '<span class="customize-control-title">','</span>' );
