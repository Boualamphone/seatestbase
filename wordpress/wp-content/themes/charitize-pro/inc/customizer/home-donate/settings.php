...
$charitize_settings_controls['charitize-home-donate-button-text'] =
array(
    'setting' =>     array(
        'default'              => $charitize_customizer_defaults['charitize-home-donate-button-text']
    ),
    'control' => array(
        'label'                 =>  __( 'Donate Section Button Text', 'charitize' ),
        'section'               => 'charitize-donate-section-settings',
        'type'                  => 'text',
        'priority'              => 60,
        'active_callback'       => ''
