 ...
 *
 * @author  Tech Banker
 * @package google-maps-bank-business-edition/views/wizard
 * @version 2.1.0
 */
if (!defined("ABSPATH")) {
    exit;
                                ...
                                <div class="page-content">
                                    ...
                                    <div class="row row-custom">
                                        ...
                                        <div class="col-md-12 terms">
                                            <a href="<?php echo tech_banker_site_url; ?>privacy-policy/" target="_blank">Privacy Policy</a>
                                            <span> - </span>
                                            <a href="<?php echo tech_banker_site_url; ?>terms-conditions/" target="_blank">Terms &amp; Conditions</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
