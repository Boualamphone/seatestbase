   ...
   if (!$access_granted) {
      ...
      if (isset($_REQUEST["param"])) {
         ...
         switch (esc_attr($_REQUEST["param"])) {
            ...
            if (wp_verify_nonce((isset($_REQUEST["_wp_nonce"]) ? $_REQUEST["_wp_nonce"] : ""), "google_maps_check_status")) {
            ...
            case "delete_data_google_maps":
               if (wp_verify_nonce(isset($_REQUEST["_wp_nonce"]) ? $_REQUEST["_wp_nonce"] : "", "google_maps_delete_nonce")) {
            ...
            case "delete_maps_data_google_maps":
               if (wp_verify_nonce(isset($_REQUEST["_wp_nonce"]) ? $_REQUEST["_wp_nonce"] : "", "google_maps_data_delete_nonce")) {
                  $meta_id = isset($_REQUEST["id"]) ? intval($_REQUEST["id"]) : "";
                  $where_parent = array();
                  $where = array();
            ...
            case "google_maps_add_maps":
               if (wp_verify_nonce(isset($_REQUEST["_wp_nonce"]) ? $_REQUEST["_wp_nonce"] : "", "google_maps_add_maps_nonce")) {
            ...
            case "google_maps_add_marker":
               if (wp_verify_nonce(isset($_REQUEST["_wp_nonce"]) ? $_REQUEST["_wp_nonce"] : "", "google_maps_add_marker_nonce")) {
                  ...
                  $marker_data_array["marker_icon_url"] = isset($_REQUEST["icon_url"]) ? sanitize_text_field($_REQUEST["icon_url"]) : "";
                  $marker_data_array["marker_icon_id"] = isset($_REQUEST["icon_id"]) ? sanitize_text_field($_REQUEST["icon_id"]) : "";
            ...
            case "google_map_polygon_module" :
               if (wp_verify_nonce(isset($_REQUEST["_wp_nonce"]) ? $_REQUEST["_wp_nonce"] : "", "google_maps_polygon_nonce")) {
                  ...
                  $polygon_form_data_array["polygon_info_window"] = sanitize_text_field($polygon_form_data["ux_ddl_polygon_info_window"]);
            ...
            case "google_maps_add_polyline":
               if (wp_verify_nonce(isset($_REQUEST["_wp_nonce"]) ? $_REQUEST["_wp_nonce"] : "", "google_maps_add_polyline_nonce")) {
                  ...
                  $add_polyline_array["polyline_info_window"] = sanitize_text_field($polyline_form_data["ux_ddl_polyline_info_window"]);
            ...
            case "google_map_overlay_circle":
               if (wp_verify_nonce(isset($_REQUEST["_wp_nonce"]) ? $_REQUEST["_wp_nonce"] : "", "google_map_add_circle_nonce")) {
                  ...
                  $circle_data_array["circle_info_window"] = sanitize_text_field($circle_form_data["ux_ddl_circle_info_window"]);
            ...
            case "add_maps_layers":
               if (wp_verify_nonce(isset($_REQUEST["_wp_nonce"]) ? $_REQUEST["_wp_nonce"] : "", "add_maps_layers_nonce")) {
            ...
            case "delete_store_locator_google_maps":
               if (wp_verify_nonce(isset($_REQUEST["_wp_nonce"]) ? $_REQUEST["_wp_nonce"] : "", "store_locator_delete_nonce")) {
                  $meta_id = isset($_REQUEST["id"]) ? intval($_REQUEST["id"]) : "";
                  $where_parent = array();
                  $where = array();
            ...
            case "gmb_info_window_module" :
               if (wp_verify_nonce(isset($_REQUEST["_wp_nonce"]) ? $_REQUEST["_wp_nonce"] : "", "info_window_nonce")) {
            ...
            case "google_map_customization_module":
               if (wp_verify_nonce(isset($_REQUEST["_wp_nonce"]) ? $_REQUEST["_wp_nonce"] : "", "google_map_customization_nonce")) {
